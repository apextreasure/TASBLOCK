    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-20 space-y-12">
      ...
      <section aria-label="Pilihan perkhidmatan" className="space-y-6">
        ...
        <article className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 sm:p-10 space-y-8">
          <figure><img src={`/images/${service.id}.webp`} alt={`Ilustrasi ${service.title}`} width="1440" height="960" loading="lazy" className="w-full max-h-96 object-cover rounded-2xl" /><figcaption className="text-xs text-slate-400 mt-3">Ilustrasi AI · Bukan foto kakitangan, stok atau projek sebenar.</figcaption></figure>
